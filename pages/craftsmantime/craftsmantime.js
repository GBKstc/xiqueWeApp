...
Page({
  ...
  selectClickPeople:function(e){
    ...
    var username = e.currentTarget.dataset.username//核对修改信息页面用
    var storename = e.currentTarget.dataset.storename//核对修改信息页面用
    var timeFormat = that.data.timeformat//
    var isReplaceTime = that.data.isReplaceTime
